...
Validates dataset quality and tests data_manager functions.
"""

from datetime import datetime
import pandas as pd
from data_manager import load_slots, load_segments, update_slot_status, append_to_log
...
def validate():
    ...
    # 3. historical_fill_rate between 0 and 1
    ...
    # 7. Low fill rate for weekday afternoons
    ...
    # Required columns in customer_segments.csv
    ...
    print("\n--- 2. TESTING DATA_MANAGER.PY FUNCTIONS ---")
    ...
    log_df = pd.read_csv("data/booking_log.csv")
    ...
    print("\nALL VALIDATION AND TESTS PASSED SUCCESSFULLY!")
